...
<body>
    <div class="main">
    <h2>Rentalr Real estate company</h2>
    <section class="login section">
            <div class="row">
                <div class="login-page">
                    <div class="form">
                        <form action="loginsavedetails.php" method="POST" class="needs-validation" novalidate>
                                 <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input id="emailAddress" name="user.EmailAddress" type="email" required maxlength="100" class="form-control"
                                ...
                                <div id="owner-email-address" class="form-group col-md-6" style="display: none;">
                                    ...
                                    <div class="invalid-feedback">Please input a valid email address.</div>
                                    <span class="form-text">Enter the email address of your landlord or property manager. We'll send them an
                                        invite to Rentarl.</span>
                                </div>
                            </div>
                        
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <input id="password" name="user.Password" type="password" required maxlength="30" class="form-control"
                            ...
                            <div id="international-fields" class="row" style="display: none;">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="user_Preferences_DateFormat" name="user.Preferences.DateFormat"
                                        required="True">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" id="user_Preferences_CurrencyFormat" name="user.Preferences.CurrencyFormat"
                                        required="True">
                                        <option value="$">$</option>
                                        <option value="&#xA3;">&#xA3;</option>
                                        <option value="&#x20AC;">&#x20AC;</option>
                            ...
                            <div class="form-group center">
                                <button id="signup-button" type="submit" class="btn btn-primary btn-lg">Start your Free Trial <i
